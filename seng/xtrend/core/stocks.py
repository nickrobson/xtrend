...
def get(rics = [], upper_window = 0, lower_window = 0, doi = date(1970, 1, 1)):
    ...
    if len(missing_rics):
        ...
        for ric in missing_rics:
            query_results.append(query_see_sharp(ric, upper_window = upper_window, lower_window = lower_window, doi = doi))
...
def query_see_sharp(ric, upper_window = 0, lower_window = 0, doi = date(1970, 1, 1)):
    parameters = [
        ('InstrumentID', ric),
